create View bill_view as (select  customer_order.id, customer_order.ticket_code, customer_order.price, customer_order.seating, schedule.start_time as movie_schedule,
    ...
    left join pair ON customer_order.pair_id=pair.id
