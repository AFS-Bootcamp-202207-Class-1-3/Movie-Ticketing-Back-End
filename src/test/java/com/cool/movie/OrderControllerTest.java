...
public class OrderControllerTest {
    ...
    public void should_return_orderListResponses_when_get_getOrderList_given_userId_startPage_pageSize() throws Exception {
        ...
        int userId = 1;
        //when then
        mockMvc.perform(MockMvcRequestBuilders.get("/order/getOrderList?pageSize=10&pageNumber=1&userId=1"))
                .andExpect(MockMvcResultMatchers.status().isOk())
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.totalOrders").value("8"))
                .andExpect(MockMvcResultMatchers.jsonPath("$.ordersCount").value("8"));
    }
